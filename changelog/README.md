...
User-facing changelog entries for daanio releases. One JSON file per release,
written by the agent during `/cut-release`, reviewed in the release diff, and
consumed by daanio.com and the GitHub release body.
...
- Write for users of daanio, not contributors. Describe the effect, not the
