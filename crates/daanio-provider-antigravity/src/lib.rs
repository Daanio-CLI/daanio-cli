...
use daanio_provider_gemini::CodeAssistGenerateResponse;
...
/// daanio emits, so no schema rewriting is needed for these models.
...
/// differently. daanio's emitted schemas are valid JSON Schema draft 2020-12
