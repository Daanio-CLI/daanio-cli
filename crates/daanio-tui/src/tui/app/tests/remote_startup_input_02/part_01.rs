...
fn test_remote_hydrated_catalog_restores_missing_direct_bedrock_route() {
    with_temp_daanio_home(|| {
        let previous_enable = std::env::var_os("DAANIO_BEDROCK_ENABLE");
        crate::env::set_var("DAANIO_BEDROCK_ENABLE", "1");
        ...
        match previous_enable {
            Some(value) => crate::env::set_var("DAANIO_BEDROCK_ENABLE", value),
            None => crate::env::remove_var("DAANIO_BEDROCK_ENABLE"),
        }
        crate::auth::AuthStatus::invalidate_cache();
...
#[test]
fn test_remote_daanio_subscription_catalog_is_not_augmented_with_local_auth_routes() {
    with_temp_daanio_home(|| {
        ...
        app.remote_provider_name =
            Some(crate::subscription_catalog::DAANIO_PROVIDER_DISPLAY_NAME.to_string());
...
#[test]
fn test_remote_mixed_catalog_keeps_daanio_subscription_separate_from_other_providers() {
...
fn test_remote_hydrated_catalog_adds_all_daanio_subscription_routes() {
    with_temp_daanio_home(|| {
        ...
        crate::env::set_var(crate::subscription_catalog::DAANIO_TIER_ENV, "plus");
        ...
        match previous_key {
            Some(value) => {
                crate::env::set_var(crate::subscription_catalog::DAANIO_API_KEY_ENV, value)
            }
            None => crate::env::remove_var(crate::subscription_catalog::DAANIO_API_KEY_ENV),
        }
        match previous_tier {
            Some(value) => crate::env::set_var(crate::subscription_catalog::DAANIO_TIER_ENV, value),
            None => crate::env::remove_var(crate::subscription_catalog::DAANIO_TIER_ENV),
        }
...
#[test]
fn test_remote_non_daanio_catalog_repairs_poisoned_all_daanio_routes() {
    with_temp_daanio_home(|| {
        let previous_tier = std::env::var_os(crate::subscription_catalog::DAANIO_TIER_ENV);
        crate::env::set_var(crate::subscription_catalog::DAANIO_TIER_ENV, "plus");
