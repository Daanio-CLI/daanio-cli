...
#[test]
fn test_subscription_command_shows_daanio_status_scaffold() {
    let _guard = crate::storage::lock_test_env();
    crate::subscription_catalog::clear_runtime_env();
    crate::env::remove_var(crate::subscription_catalog::DAANIO_API_KEY_ENV);
    crate::env::remove_var(crate::subscription_catalog::DAANIO_API_BASE_ENV);
    ...
    assert_eq!(msg.role, "system");
    assert!(msg.content.contains("Daanio Subscription Status"));
    assert!(msg.content.contains("/login daanio"));
