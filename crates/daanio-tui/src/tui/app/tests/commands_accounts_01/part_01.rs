    ...
    app.session_picker_overlay = Some(RefCell::new(
        crate::tui::session_picker::SessionPicker::new(vec![
            crate::tui::session_picker::SessionInfo {
                ...
                server_name: None,
                server_icon: None,
                source: crate::tui::session_picker::SessionSource::Daanio,
                resume_target: crate::tui::session_picker::ResumeTarget::DaanioSession {
...
fn test_help_topic_shows_log_command_details() {
    ...
    assert!(msg.content.contains("DAANIO_LOG_MARK"));
}
...
fn test_git_command_works_in_remote_mode_with_accessible_working_directory() {
    ...
    assert!(
        !msg.content
            .contains("currently only available in a local daanio TUI session")
    );
}
