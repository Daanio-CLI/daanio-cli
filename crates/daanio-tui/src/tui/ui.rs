...
pub(crate) use daanio_tui_markdown::{CopyTargetKind, RawCopyTarget};
pub(crate) use daanio_tui_messages::{
...
impl CopyViewportSnapshot {
    ...
    fn inline_image_id_for_label_line(&self, abs_line: usize) -> Option<u64> {
        ...
        prepared
            ...
            .iter()
            .find(|region| {
                region.render == daanio_tui_messages::ImageRegionRender::Fit
