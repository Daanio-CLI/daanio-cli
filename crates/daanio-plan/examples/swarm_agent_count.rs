...
//!
//! This drives the *real* task-DAG engine (`daanio_plan::dag`) with scripted mock
...
//!
//! Run with: `cargo run -p daanio-plan --example swarm_agent_count`
//!
...
use daanio_plan::dag::sim::deep_artifact;
use daanio_plan::dag::{
