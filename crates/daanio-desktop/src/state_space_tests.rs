...
//!
//! Run with:
//!   cargo test -p daanio-desktop state_space -- --nocapture
...
fn walk_budget() -> WalkBudget {
    WalkBudget {
        max_depth: env_usize("DAANIO_WALK_DEPTH", MAX_DEPTH),
        max_unique_states: env_usize("DAANIO_WALK_STATES", MAX_UNIQUE_STATES_PER_SEED),
