...
pub(crate) fn single_session_user_font_family() -> &'static str {
    ...
    .or_else(|| desktop_font_family_from_env("DAANIO_DESKTOP_USER_FONT"))
...
pub(crate) fn single_session_assistant_font_family() -> &'static str {
    ...
    .or_else(|| desktop_font_family_from_env("DAANIO_DESKTOP_AI_FONT"))
    .or_else(|| desktop_font_family_from_env("DAANIO_DESKTOP_ASSISTANT_FONT"))
        ...
        match session_data::load_session_transcript_by_id(session_id) {
            ...
            Err(error) => {
                crate::desktop_log::warn(format_args!(
                    "daanio-desktop: failed to hydrate resumed transcript for {session_id}: {error:#}"
                ));
...
pub(crate) fn single_session_surface(
    ...
    workspace::Surface {
        ...
        title: session
            ...
            .unwrap_or_else(|| "new daanio session".to_string()),
