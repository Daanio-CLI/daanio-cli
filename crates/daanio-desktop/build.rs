...
fn main() {
    ...
    println!("cargo:rustc-env=DAANIO_DESKTOP_VERSION={version}");
    println!("cargo:rustc-env=DAANIO_PRODUCT_VERSION={product_version}");
    println!("cargo:rustc-env=DAANIO_DESKTOP_GIT_HASH={git_hash}");
