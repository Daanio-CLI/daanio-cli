...
/// Daanio's documented OpenAI-compatible API.
///
/// See https://daanio.com/docs/getting-started and
/// https://daanio.com/docs/codex.
pub const DAANIO_PROFILE: OpenAiCompatibleProfile = OpenAiCompatibleProfile {
    id: "daanio",
    display_name: "Daanio",
    api_base: "https://api.daanio.com/v1",
    api_key_env: "DAANIO_API_KEY",
    env_file: "daanio.env",
    setup_url: "https://daanio.com/docs/getting-started",
...
pub const DAANIO_LOGIN_PROVIDER: LoginProviderDescriptor = LoginProviderDescriptor {
    id: "daanio",
    display_name: "Daanio",
    auth_kind: LoginProviderAuthKind::DeviceCode,
    auth_state_key: LoginProviderAuthStateKey::Daanio,
    auth_status_method: "browser sign-in",
    aliases: &["daanio-api", "daanio-gateway"],
    menu_detail: "sign in securely at daanio.com · no key copy/paste",
    recommended: true,
    target: LoginProviderTarget::Daanio,
