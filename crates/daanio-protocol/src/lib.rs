//! Client-server protocol for daanio
//!
...
use daanio_batch_types::BatchProgress;
use daanio_message_types::{InputShellResult, ToolCall};
use daanio_plan::{PlanItem, VersionedPlan, next_runnable_item_ids, summarize_plan_graph};
use daanio_side_panel_types::{SidePanelSnapshot, snapshot_is_empty};
...
pub type ReloadRecoverySnapshot = daanio_selfdev_types::ReloadRecoveryDirective;
...
impl PlanGraphStatus {
    ...
    pub fn from_versioned_plan(
        ...
        let growth = daanio_plan::bridge::growth_stats(plan);
        ...
        Self {
            ...
            newly_ready_ids,
            low_confidence_ids: daanio_plan::bridge::low_confidence_completed_ids(plan),
