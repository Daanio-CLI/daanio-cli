...
/// Mirrors `daanio_plan::dag::NodeSpec` but kept as an explicit wire type so the
...
pub enum Request {
    ...
    Reload {
        ...
        /// `daanio server reload` can request a graceful upgrade without risking
    ...
    SetRoute {
        id: u64,
        selection: daanio_provider_core::RouteSelection,
    },
    ...
    SetCompactionMode {
        id: u64,
        mode: daanio_config_types::CompactionMode,
    },
    ...
    /// Query daanio agent's capabilities
...
pub enum ServerEvent {
    ...
    SidePaneImages {
        session_id: String,
        images: Vec<daanio_session_types::RenderedImage>,
    },
    ...
    History {
        ...
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        available_model_routes: Vec<daanio_provider_core::ModelRoute>,
        ...
        #[serde(default, skip_serializing_if = "Option::is_none")]
        resolved_credential: Option<daanio_provider_core::ResolvedCredential>,
        ...
        #[serde(default)]
        compaction_mode: daanio_config_types::CompactionMode,
    ...
    CommListModelsResponse {
        ...
        #[serde(default, skip_serializing_if = "Vec::is_empty")]
        model_routes: Vec<daanio_provider_core::ModelRoute>,
    },
