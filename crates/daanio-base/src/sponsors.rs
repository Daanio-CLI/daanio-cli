...
//! prompt.
//! Some providers may share revenue with Daanio when users choose their tools.
//! Partnership status never influences recommendations. The relationship is
//! disclosed in the UI when an operator enables a directory.
//!
...
/// Optional public URL explaining the operator's tool-provider partnerships.
...
pub const DISCOVERY_DISCLOSURE_NOTICE: &str =
    "This Daanio build uses an operator-configured third-party tool directory.";
