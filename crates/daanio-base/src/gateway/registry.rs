...
use crate::storage;
use daanio_gateway_types::{PairedDevice, PairingCode};

// ---------------------------------------------------------------------------
// Device registry (persisted to ~/.daanio/devices.json)
// ---------------------------------------------------------------------------
...
impl DeviceRegistry {
    /// Load from ~/.daanio/devices.json
    pub fn load() -> Self {
        let path = match storage::daanio_dir() {
    ...
    /// Save to ~/.daanio/devices.json
    pub fn save(&self) -> Result<()> {
        let path = storage::daanio_dir()?.join("devices.json");
