...
pub use daanio_task_types::{TodoGoal, TodoGoalChange, TodoGoalField, TodoItem};
...
/// `daanio run` auto-poke) and the transcript renderer agree on the exact text.
