...
pub const DAANIO_API_KEY_ENV: &str = "DAANIO_API_KEY";
pub const DAANIO_API_BASE_ENV: &str = "DAANIO_API_BASE";
pub const DAANIO_ACCOUNT_ID_ENV: &str = "DAANIO_ACCOUNT_ID";
pub const DAANIO_ACCOUNT_EMAIL_ENV: &str = "DAANIO_ACCOUNT_EMAIL";
pub const DAANIO_TIER_ENV: &str = "DAANIO_TIER";
...
pub const DAANIO_ROUTE_API_METHOD: &str = "daanio-subscription";
...
impl DaanioTier {
    pub const ALL: &'static [DaanioTier] = &[
        DaanioTier::Plus,
        DaanioTier::Pro,
        DaanioTier::Max,
        DaanioTier::Ultra,
...
pub enum UpstreamRoutingPolicy {
    /// Routing is decided server-side by the daanio router (model -> provider +
...
pub const CURATED_MODELS: &[CuratedModel] = &[
    CuratedModel {
        ...
        min_tier: DaanioTier::Plus,
        note: "Frontier model; routed server-side to Anthropic by the daanio router.",
    },
    CuratedModel {
        ...
        routing_policy: UpstreamRoutingPolicy::ServerManaged,
        min_tier: DaanioTier::Plus,
        note: "Frontier model; routed server-side to Amazon Bedrock by the daanio router.",
    },
    CuratedModel {
        id: "gpt-5.5",
        ...
        routing_policy: UpstreamRoutingPolicy::ServerManaged,
        min_tier: DaanioTier::Plus,
        note: "Frontier model; routed server-side to OpenAI by the daanio router.",
    },
    CuratedModel {
        id: "claude-fable-5",
        ...
        default_enabled: false,
        routing_policy: UpstreamRoutingPolicy::ServerManaged,
        min_tier: DaanioTier::Ultra,
        note: "Ultra-tier model; routed server-side to Anthropic by the daanio router.",
    },
    CuratedModel {
        id: "gpt-5.6-sol",
    ...
    CuratedModel {
        ...
        routing_policy: UpstreamRoutingPolicy::ServerManaged,
        min_tier: DaanioTier::Plus,
        note: "Open-weight coding model; routed server-side to Amazon Bedrock by the daanio router.",
    },
    CuratedModel {
        id: "devstral-2-123b",
    ...
    CuratedModel {
        ...
        routing_policy: UpstreamRoutingPolicy::ServerManaged,
        min_tier: DaanioTier::Plus,
        note: "Open-weight reasoning and coding model; routed server-side to Amazon Bedrock by the daanio router.",
    },
    CuratedModel {
        id: "nova-2-lite",
        ...
        routing_policy: UpstreamRoutingPolicy::ServerManaged,
        min_tier: DaanioTier::Plus,
        note: "Recent efficient multimodal model; routed server-side to Amazon Bedrock by the daanio router.",
    },
    CuratedModel {
        id: "minimax-m2.5",
        ...
        routing_policy: UpstreamRoutingPolicy::ServerManaged,
        min_tier: DaanioTier::Plus,
        note: "Recent reasoning and coding model; routed server-side to Amazon Bedrock by the daanio router.",
    },
    CuratedModel {
        id: "mistral-large-3",
        ...
        routing_policy: UpstreamRoutingPolicy::ServerManaged,
        min_tier: DaanioTier::Plus,
        note: "Open-weight general and coding model; routed server-side to Amazon Bedrock by the daanio router.",
    },
    CuratedModel {
        id: "kimi-k2.5",
        ...
        routing_policy: UpstreamRoutingPolicy::ServerManaged,
        min_tier: DaanioTier::Plus,
        note: "Recent reasoning and agentic model; routed server-side to Amazon Bedrock by the daanio router.",
    },
    CuratedModel {
        id: "kimi-k2-thinking",
        ...
        routing_policy: UpstreamRoutingPolicy::ServerManaged,
        min_tier: DaanioTier::Plus,
        note: "Reasoning-focused model; routed server-side to Amazon Bedrock by the daanio router.",
    },
    CuratedModel {
        ...
        routing_policy: UpstreamRoutingPolicy::ServerManaged,
        min_tier: DaanioTier::Plus,
        note: "Efficient open-weight reasoning model; routed server-side to Amazon Bedrock by the daanio router.",
    },
    CuratedModel {
        id: "gpt-oss-120b",
        ...
        routing_policy: UpstreamRoutingPolicy::ServerManaged,
        min_tier: DaanioTier::Plus,
        note: "Large open-weight reasoning model; routed server-side to Amazon Bedrock by the daanio router.",
    },
    CuratedModel {
        id: "gpt-oss-20b",
    ...
    CuratedModel {
        ...
        routing_policy: UpstreamRoutingPolicy::ServerManaged,
        min_tier: DaanioTier::Plus,
        note: "Recent general and coding model; routed server-side to Amazon Bedrock by the daanio router.",
    },
    CuratedModel {
        id: "glm-4.7-flash",
        ...
        routing_policy: UpstreamRoutingPolicy::ServerManaged,
        min_tier: DaanioTier::Plus,
        note: "Efficient recent general model; routed server-side to Amazon Bedrock by the daanio router.",
    },
];
...
fn normalize_model_key(model: &str) -> String {
    ...
    daanio_provider_core::model_id::canonical(base)
}
...
pub fn cached_tier() -> Option<DaanioTier> {
    provider_catalog::load_env_value_from_env_or_config(DAANIO_TIER_ENV, DAANIO_ENV_FILE)
        .as_deref()
        .and_then(DaanioTier::parse)
}

/// Persist the last-known tier reported by the backend (`None` clears it).
pub fn store_cached_tier(tier: Option<DaanioTier>) -> anyhow::Result<()> {
...
pub fn routing_policy_detail(model: &CuratedModel) -> String {
    match model.routing_policy {
        UpstreamRoutingPolicy::ServerManaged => {
            "daanio subscription routing · managed server-side".to_string()
        }
    }
}

pub fn configured_api_key() -> Option<String> {
    provider_catalog::load_env_value_from_env_or_config(DAANIO_API_KEY_ENV, DAANIO_ENV_FILE)
}

pub fn configured_api_base() -> Option<String> {
    provider_catalog::load_env_value_from_env_or_config(DAANIO_API_BASE_ENV, DAANIO_ENV_FILE)
}
...
/// Persist an account API key and its non-secret account metadata in daanio's
...
pub fn persist_account_credentials(
    ...
    if api_key.is_empty() {
        anyhow::bail!("refusing to persist an empty daanio account API key");
    }

    for (key, value) in [
        (DAANIO_API_KEY_ENV, Some(api_key)),
        (DAANIO_ACCOUNT_ID_ENV, nonempty(account_id)),
        (DAANIO_ACCOUNT_EMAIL_ENV, nonempty(email)),
        (DAANIO_TIER_ENV, nonempty(tier)),
    ] {
        provider_catalog::save_env_value_to_env_file(key, DAANIO_ENV_FILE, value)?;
    }
...
pub fn clear_account_credentials() -> anyhow::Result<()> {
    for key in [
        DAANIO_API_KEY_ENV,
        DAANIO_ACCOUNT_ID_ENV,
        DAANIO_ACCOUNT_EMAIL_ENV,
        DAANIO_TIER_ENV,
    ] {
        provider_catalog::save_env_value_to_env_file(key, DAANIO_ENV_FILE, None)?;
    }
    clear_runtime_env();
    ensure_account_credential_permissions()
}
...
pub fn account_credential_path() -> anyhow::Result<std::path::PathBuf> {
    Ok(crate::storage::app_config_dir()?.join(DAANIO_ENV_FILE))
}
...
pub fn ensure_account_credential_permissions() -> anyhow::Result<()> {
    ...
    #[cfg(unix)]
    {
        ...
        if mode & 0o077 != 0 {
            anyhow::bail!(
                "daanio account credential file has unsafe permissions {:03o}; expected owner-only access",
                mode
            );
        }
    }
...
pub fn has_router_base() -> bool {
    configured_api_base().is_some() || !DEFAULT_DAANIO_API_BASE.is_empty()
}

pub fn is_runtime_mode_enabled() -> bool {
    std::env::var(DAANIO_SUBSCRIPTION_ACTIVE_ENV)
        .ok()
        .map(|value| {
            matches!(
...
pub fn apply_runtime_env() {
    crate::env::set_var(DAANIO_SUBSCRIPTION_ACTIVE_ENV, "1");
    crate::env::set_var(
        "DAANIO_OPENROUTER_API_BASE",
        configured_api_base().unwrap_or_else(|| DEFAULT_DAANIO_API_BASE.to_string()),
    );
    crate::env::set_var("DAANIO_OPENROUTER_API_KEY_NAME", DAANIO_API_KEY_ENV);
    crate::env::set_var("DAANIO_OPENROUTER_ENV_FILE", DAANIO_ENV_FILE);
    crate::env::set_var("DAANIO_OPENROUTER_CACHE_NAMESPACE", DAANIO_CACHE_NAMESPACE);
    crate::env::set_var("DAANIO_OPENROUTER_PROVIDER_FEATURES", "0");
    crate::env::set_var("DAANIO_OPENROUTER_TRANSPORT_STATE", "daanio-subscription");
    crate::env::remove_var("DAANIO_OPENROUTER_ALLOW_NO_AUTH");
    crate::env::remove_var("DAANIO_OPENROUTER_PROVIDER");
    crate::env::remove_var("DAANIO_OPENROUTER_NO_FALLBACK");
}

pub fn clear_runtime_env() {
    crate::env::remove_var(DAANIO_SUBSCRIPTION_ACTIVE_ENV);
    crate::env::remove_var("DAANIO_OPENROUTER_API_BASE");
    crate::env::remove_var("DAANIO_OPENROUTER_API_KEY_NAME");
    crate::env::remove_var("DAANIO_OPENROUTER_ENV_FILE");
    crate::env::remove_var("DAANIO_OPENROUTER_CACHE_NAMESPACE");
    crate::env::remove_var("DAANIO_OPENROUTER_PROVIDER_FEATURES");
    crate::env::remove_var("DAANIO_OPENROUTER_TRANSPORT_STATE");
    crate::env::remove_var("DAANIO_OPENROUTER_ALLOW_NO_AUTH");
    crate::env::remove_var("DAANIO_OPENROUTER_PROVIDER");
    crate::env::remove_var("DAANIO_OPENROUTER_NO_FALLBACK");
}
...
mod tests {
    ...
    fn curated_catalog_has_exact_paid_and_ultra_sets() {
        assert_eq!(
            CURATED_MODELS
                .iter()
                .filter(|model| model.min_tier == DaanioTier::Plus)
                .map(|model| model.id)
                .collect::<Vec<_>>(),
        ...
        assert_eq!(
            CURATED_MODELS
                .iter()
                .filter(|model| model.min_tier == DaanioTier::Ultra)
                .map(|model| model.id)
                .collect::<Vec<_>>(),
            vec!["claude-fable-5"]
        );
        assert!(
            CURATED_MODELS
                .iter()
                .all(|model| model.min_tier != DaanioTier::Flagship)
        );
    ...
    fn tier_pricing_matches_launched_plans() {
        let expected = [
            (DaanioTier::Plus, "plus", "Plus", 10, 18.00),
            (DaanioTier::Pro, "pro", "Pro", 20, 40.00),
            (DaanioTier::Max, "max", "Max", 100, 225.00),
            (DaanioTier::Ultra, "ultra", "Ultra", 200, 500.00),
            (DaanioTier::Flagship, "flagship", "Solo", 1000, 3000.00),
        ];

        assert_eq!(DaanioTier::ALL, expected.map(|(tier, ..)| tier));
    ...
    fn tier_parse_round_trips() {
        for tier in DaanioTier::ALL {
            assert_eq!(DaanioTier::parse(tier.as_str()), Some(*tier));
        }
        assert_eq!(DaanioTier::parse("PLUS"), Some(DaanioTier::Plus));
        assert_eq!(DaanioTier::parse(" Pro "), Some(DaanioTier::Pro));
        assert_eq!(DaanioTier::parse("MAX"), Some(DaanioTier::Max));
        assert_eq!(DaanioTier::parse(" ultra "), Some(DaanioTier::Ultra));
        assert_eq!(DaanioTier::parse(" Flagship "), Some(DaanioTier::Flagship));
        assert_eq!(DaanioTier::parse(" Solo "), Some(DaanioTier::Flagship));
        assert_eq!(DaanioTier::parse("starter"), None);
    }
