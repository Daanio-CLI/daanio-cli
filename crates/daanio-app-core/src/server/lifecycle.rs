...
const TEMP_SERVER_ENV: &str = "DAANIO_TEMP_SERVER";
const SERVER_SCOPE_ENV: &str = "DAANIO_SERVER_SCOPE";
const OWNER_PID_ENV: &str = "DAANIO_SERVER_OWNER_PID";
const TEMP_IDLE_SECS_ENV: &str = "DAANIO_TEMP_SERVER_IDLE_SECS";
...
mod tests {
    ...
    fn temporary_metadata_path_is_socket_scoped() {
        assert_eq!(
            metadata_path(Path::new("/tmp/example/daanio.sock")),
            PathBuf::from("/tmp/example/daanio.sock.server.json")
        );
    }
