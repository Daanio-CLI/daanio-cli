use super::{Agent, DAANIO_REPO_SOURCE_STATE, WORKING_GIT_STATE_CACHE};
use crate::logging;
...
impl Agent {
    ...
    pub(super) fn build_env_snapshot(
        ...
        let (daanio_git_hash, daanio_git_dirty) = match detail {
            EnvSnapshotDetail::Full => DAANIO_REPO_SOURCE_STATE.clone(),
        ...
        EnvSnapshot {
            ...
            daanio_version: daanio_build_meta::version().to_string(),
            daanio_git_hash,
            daanio_git_dirty,
