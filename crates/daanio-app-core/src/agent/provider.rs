...
impl Agent {
    ...
    pub fn model_catalog_snapshot(&self) -> daanio_provider_core::ModelCatalogSnapshot {
    ...
    pub fn active_resolved_credential(&self) -> Option<daanio_provider_core::ResolvedCredential> {
