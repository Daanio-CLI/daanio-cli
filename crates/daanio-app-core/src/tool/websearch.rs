        ...
        json!({
            ...
            "properties": {
                ...
                "engine": {
                    ...
                    "description": "Search engine. Defaults to duckduckgo. Bing uses DAANIO_BING_API_KEY when set, otherwise Bing HTML scraping. searxng queries a configured SearXNG instance (DAANIO_SEARXNG_URL)."
                },
                "bing_market": {
                    "type": "string",
                    "description": "Optional Bing market, e.g. en-US or zh-CN. Defaults to DAANIO_BING_MARKET or en-US."
                }
            }
        })
    }
        ...
        if results.is_empty() {
            return Ok(ToolOutput::new(format!(
                "No results found for: {}\n\n\
                 ...
                 DAANIO_SEARXNG_URL) and use engine \"searxng\".\n\
                 - Or provide a Bing Search API key via DAANIO_BING_API_KEY.",
                params.query
            )));
        }
...
mod tests {
    ...
    fn parses_bing_html_results() {
        let html = r#"
            ...
            <li class="b_algo">
              <h2><a href="https://example.org/daanio">Daanio</a></h2>
        ...
        assert_eq!(results[1].title, "Daanio");
    }
