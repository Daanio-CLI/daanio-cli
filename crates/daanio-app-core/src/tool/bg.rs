...
impl Tool for BgTool {
    ...
    fn description(&self) -> &str {
        "Manage background tasks. Prefer action='wait' over polling or sleeping. Use action='tail' or output with tail_lines for logs, action='delivery' to change notify/wake behavior, and DAANIO_CHECKPOINT/DAANIO_PROGRESS from background commands for reliable wakeups."
    }
