...
- Convert MCP tools to daanio Tool trait
...
2. daanio spawns the process, does MCP handshake
...
**Initialize:**
```json
{"jsonrpc":"2.0","id":1,"method":"initialize","params":{"protocolVersion":"2024-11-05","capabilities":{},"clientInfo":{"name":"daanio","version":"0.1.0"}}}
```
