...
mod tests {
    ...
    fn provider_add_writes_named_profile_env_file_and_default() {
        ...
        let _key = EnvVarGuard::remove("DAANIO_PROVIDER_MY_API_API_KEY");
        ...
        assert_eq!(
            ...
            Some("DAANIO_PROVIDER_MY_API_API_KEY")
        );
        ...
        assert!(env_content.contains("DAANIO_PROVIDER_MY_API_API_KEY=secret-test-key"));
    }
