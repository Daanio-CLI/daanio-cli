#!/usr/bin/env python3
"""Analyze the monolithic root `daanio` crate to plan a bottom-up split.
...
computes:
  ...
  - facade: whether it is already just `pub use daanio_*::*;`
...
FACADE_RE = re.compile(r"pub use daanio_[a-z0-9_]+::")
