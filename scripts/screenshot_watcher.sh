#!/bin/bash
# Screenshot Watcher - monitors for daanio screenshot signals
#
# This script watches the signal directory and captures screenshots
# when daanio signals that a specific UI state is ready.
#
# Usage: ./screenshot_watcher.sh [window_id]
#
# Start daanio with: /screenshot-mode on

set -e

SIGNAL_DIR="${XDG_RUNTIME_DIR:-/tmp}/daanio-screenshots"
...
echo "Enable in daanio with: /screenshot-mode on"
echo ""
