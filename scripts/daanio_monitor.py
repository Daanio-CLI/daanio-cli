#!/usr/bin/env python3
"""
daanio Live Monitor - Real-time activity dashboard

Connects to daanio's debug socket and displays live streaming events.
Run daanio serve in one terminal, then this monitor in another.

Usage: ./daanio_monitor.py [--socket PATH]
"""
...
def get_socket_path() -> str:
    """Get the daanio debug socket path"""
