...
SOCKET_PATH = f"/run/user/{os.getuid()}/daanio-debug.sock"
MAIN_SOCKET_PATH = f"/run/user/{os.getuid()}/daanio.sock"
...
def main():
    ...
    if not os.path.exists(SOCKET_PATH):
        ...
        print("Make sure daanio server is running with debug control enabled.")
