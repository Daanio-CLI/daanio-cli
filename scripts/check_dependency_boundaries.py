...
small: it blocks direct dependencies from any `daanio-*-types` crate to root or
...
FORBIDDEN_INTERNAL_DEPS = {
    ...
    "daanio-provider-metadata",
    "daanio-provider-openrouter",
    "daanio-protocol",
    "daanio-terminal-launch",
    "daanio-tui-core",
    "daanio-tui-markdown",
    "daanio-tui-mermaid",
    "daanio-tui-render",
    "daanio-tui-workspace",
}
...
def is_type_crate(name: str) -> bool:
    return name.startswith("daanio-") and name.endswith("-types")
