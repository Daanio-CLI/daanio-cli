...
This document defines the safe, incremental path for refactoring daanio while preserving behavior.
...
- Compile timing: `scripts/bench_compile.sh check --runs 3 --touch <hot-file>` and `scripts/bench_compile.sh release-daanio --runs 3`
