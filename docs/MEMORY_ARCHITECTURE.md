...
**Examples:**
- `#project:daanio` - Project-specific
...
- [x] User control CLI (`daanio memory` commands)
...
Similar to how humans consolidate memories during sleep, daanio can run background consolidation to optimize the memory graph:
