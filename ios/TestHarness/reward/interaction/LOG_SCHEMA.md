# daanio TUI log schema (for grounding the user model in real usage)

Logs live in `~/.daanio/logs/daanio-YYYY-MM-DD.log`. Lines look like:
...
1. Read the last N daily logs (default 7) under `~/.daanio/logs/`.
