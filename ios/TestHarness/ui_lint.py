#!/usr/bin/env python3
"""Design-system discipline linter for the daanio iOS SwiftUI sources.
...
Usage:
  python3 ui_lint.py [--root Sources/DaanioMobile] [--json] [--max-issues N]
...
def main():
    ...
    default_root = Path(__file__).resolve().parent.parent / "Sources" / "DaanioMobile"
