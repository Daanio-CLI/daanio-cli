#!/usr/bin/env python3
"""Deterministic mock daanio gateway for end-to-end iOS app testing.

Speaks the exact wire protocol from `crates/daanio-base/src/gateway.rs` on a
