        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                Button {
                    ...
                    Label("Scan QR from `daanio pair`", systemImage: "qrcode.viewfinder")
                        .font(.subheadline)
                        .frame(maxWidth: .infinity)
                        .padding(.vertical, 12)
                ...
                Text("Run `daanio pair` on your machine, then scan the QR code or enter the code manually. Traffic stays on your tailnet.")
                    .font(.footnote)
        ...
        .sheet(isPresented: $showScanner) {
            QRScannerView { scanned in
                ...
                if let payload = PairURI.parse(scanned) {
                    ...
                    errorMessage = "Not a daanio pairing QR code"
                }
            }
        }
    }
