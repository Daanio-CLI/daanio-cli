...
/// Client request to a daanio server.
///
/// Wire format mirrors `crates/daanio-protocol/src/wire.rs` (`#[serde(tag = "type")]`,
...
/// Server event from a daanio server. Unknown event types decode as `.unknown`
